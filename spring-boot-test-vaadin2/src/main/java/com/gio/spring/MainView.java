...
public class MainView extends UI {
	...
	protected void init(VaadinRequest request) {
		...
		ObjectProperty<String> prop2 = new ObjectProperty<String>(nameStr);
		...
		// Data Binding example w/ validation
		VerticalLayout root18 = new VerticalLayout();
		root18.setMargin(true);
		root18.setHeight("100%");
		
		//@PropertyId("name") is another way to bind with global class variables
		TextField name = new TextField("Name");
		TextField age = new TextField("Age");
		
		Person person = new Person();
		
		// this binds the nameFld and ageFld to the Person Object
		BeanFieldGroup<Person> fldGroup = new BeanFieldGroup<>(Person.class);
		fldGroup.bind(name, "name");
		fldGroup.bind(age, "age");
		fldGroup.setItemDataSource(person);
		
		Button btn18 = new Button("Save");
		btn18.addClickListener(new Button.ClickListener() {
		...
		root18.addComponent(name);
		root18.addComponent(age);
		root18.addComponent(btn18);
		// -----------------------------
